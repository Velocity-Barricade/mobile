      ...
      appBar: new AppBar(elevation: 0,backgroundColor: Colors.white,
        actions: <Widget>[
          Padding(
            ...
            child: new Icon(Icons.search,size: 26,),
          ),
        ],
        iconTheme: new IconThemeData(color: themeGrey,size: 3,),
...
//                                    color: Colors.green,
                                    child: Align(
                                        alignment: Alignment.centerLeft,
                                        child: new Text("Your friends",style: TextStyle(fontSize: 20),)),
                                  ),
                                ),
...
//                                  color: Colors.grey,
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Row(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: Row(
                                              children: <Widget>[
                                                new Text("View the complete list",style: TextStyle(fontSize: 15,color: themeGrey),),
                                                new Icon(Icons.arrow_forward,size: 15,)
                                              ],
                                            ),
                                          ),
                                        ],
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: new Text("Please dont click this !",style: TextStyle(color: themeGrey,fontSize: 15),),
                                      )
                                    ],
                                  ),
